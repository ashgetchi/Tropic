  ...
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="relative flex items-center justify-between h-16">
      <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
        <button class="inline-flex items-center justify-center p-2 rounded-md text-white-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:bg-gray-700 focus:text-white transition duration-150 ease-in-out" aria-label="Main menu" aria-expanded="false">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex-shrink-0">
          <p class="text-white ml-4 px-3 py-2 rounded-md"> TROPIC </p>
        </div>
        <div class="hidden sm:block sm:ml-6">
          <div class="flex">
            <a href="#" class="ml-4 px-3 py-2 rounded-md  font-medium leading-5 text-gray-300 hover:text-lg hover:bg-gray-700 hover:text-red transition duration-150 ease-in-out">Plants</a>
            <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-black hover:bg-white transition duration-150 ease-in-out">Pots</a>
            <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium leading-5 text-gray-300 hover:text-black hover:bg-white transition duration-150 ease-in-out">SALE</a>
          </div>
        </div>
      </div>
